...
void CCmdTextEdit::cursorPositionChanged()
{
    ...
    {
//        qDebug() << tr(u8"CCmdTextEdit->cursorPositionChanged：不是当前行，设为只读");
    ...
    else
    {
        ...
        {
//            qDebug() << tr(u8"CCmdTextEdit->cursorPositionChanged：当前行光标位置小于5，设为只读");
            this->setReadOnly(true);
        ...
        {
//            qDebug() << tr(u8"CCmdTextEdit->cursorPositionChanged：当前行光标位置大于5，设为读写");
...
void CCmdTextEdit::selectionChanged()
{
    ...
    {
//        qDebug() << tr(u8"CCmdTextEdit->selectionChanged：有选择，设为只读");
        this->setReadOnly(true);
    }
    else
    {
...
void CCmdTextEdit::keyPressEvent(QKeyEvent *event)
{
    ...
    {
//        qDebug() << tr(u8"CCmdTextEdit->keyPressEvent：可读，但不可擦除前一个字符");
        event->ignore();
        return;
    }
